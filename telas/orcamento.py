...
class TelaOrcamento(tk.Frame):
    def __init__(self, master):
        ...
        self.cb_fornec.bind("<<ComboboxSelected>>",
                            lambda e: (self._reset_autosave_context(),
        ...
        cols_s = ("id", "criado_em", "cod_aghu", "nome_item", "qtde", "vl_unit",
                  "vl_total", "numero_empenho", "observacao")
        heads_s = ("ID", "Criado em", "Cód AGHU", "Item", "Qtde", "Vlr Unit",
                   "Vlr Total", "Nº Empenho", "Obs")
